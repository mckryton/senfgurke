Ability: Report in verbose format
  ...
  Rule: A step will be preceded with it's result in capital letters initially intendented by 1 tab and then indented by 1 space and steps following after indented by 10 spaces
