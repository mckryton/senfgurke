...
Public Property Get StepImplementations() As Collection
    ...
    If m_step_implementations Is Nothing Then
        ...
        For Each step_implementation_class In Array(New Steps_Run_Examples, New Steps_Parse_Features, New Steps_Load_Feature_Files, New Steps_Verbose_Output, New Steps_Run_Steps)
